...
function App({ name, data, socket, inscriptionId }: { data: loadedAssets; name: string; socket: connectionResultType; inscriptionId?: string }) {
    // game usage
            ...
            <div className="gui">
                ...
                <div className="information">
                    <img 
                        ...
                        alt="" 
                        onError={(e) => {
                            // Fallback to donald.png if the inscription image fails to load
                            (e.target as HTMLImageElement).src = "donald.png";
                        }}
                    />
                    <div className="inner">
                        <p>{name}</p>
...
export default function (args: { 
    ...
    return (
        <AsyncTask<connectionResultType>
            ...
            resolve={(sock) => <AssetLoader assets={urls} resolve={(data) => 
                <App data={data} name={args.name} socket={sock} inscriptionId={args.inscriptionId} />} 
            />}
        />
    );
}
